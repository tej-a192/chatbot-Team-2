...
5.  **Backend Setup (Python RAG & KG Service):**
    ...
    ```
6.  **Running the Backend (RAG & Node Server):**
...
**Features that are not added into demo video but developed successfully:**

1. Agentic Framework
2. Podcast Generation to the Document
3. Web Search using duckduckgo
4. Long term memory
