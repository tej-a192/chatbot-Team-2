...
import { 
    GraduationCap, BookOpen, BrainCircuit, Code, FileQuestion, Headphones, FileBarChart2, ShieldCheck, Globe 
} from 'lucide-react';

/**
 * Feature data is derived from analysis of the source code.
 * - StudyPlanPage.jsx -> Personalized Study Plans
 * - CenterPanel.jsx -> Academic & Web Search, Critical Thinking Cues
 * - RightPanel.jsx -> Document Analysis, KG Visualization
 * - ToolsModal.jsx -> Code Executor, Quiz Generator, Integrity Checker
 * - PodcastGenerator.jsx & generation routes -> Content Creation
 */
const features = [
    {
        icon: GraduationCap,
